...
export default function Header() {
  ...
  useEffect(() => {
    ...
    if (menuOpen) {
      el.classList.add("overflow-hidden", "overflow-x-clip");
      body.classList.add("overflow-hidden", "overflow-x-clip");
    } else {
  ...
  const renderNav = (isSticky = false) => {
    // Make ARIA IDs unique for each header instance
    const moreMenuId = isSticky ? "more-menu-sticky" : "more-menu-default";
    ...
    return (
      <>
        ...
        >
          ...
          {/* Dropdown (unique ARIA id per header) */}
          <div
            className="relative"
